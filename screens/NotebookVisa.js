...
const NotebookVisa = () => {
  ...
  return (
    <View style={styles.notebookvisa}>
      <View style={[styles.barrainferior, styles.barrainferiorLayout]}>
        ...
        <Text style={[styles.r300000, styles.textFlexBox]}>R$ 3000,00</Text>
      </View>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("NotebookPix")}
      >
        <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("NotebookCartes")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("NotebookHiper")}
      >
        ...
        />
        <View style={[styles.hipercardItem, styles.childPosition]} />
      </Pressable>
      <Pressable
        style={[styles.mastercard, styles.visaLayout]}
        onPress={() => navigation.navigate("NotebookMaster")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("NovoCartoNote")}
      >
      ...
      <Text style={[styles.notebookD, styles.detalhesTypo]}>Notebook D...</Text>
      <Text style={[styles.detalhes, styles.detalhesTypo]}>Detalhes</Text>
      <Text style={[styles.r3000001, styles.textFlexBox]}>R$ 3000,00</Text>
    </View>
  );
};
