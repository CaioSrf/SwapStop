...
const PikachuQrCode = () => {
  ...
  return (
    <View style={styles.pikachuqrcode}>
      ...
      <Text style={[styles.pikachu, styles.textTypo]}>Pikachu...</Text>
      <Text style={[styles.detalhes, styles.r30000Typo]}>Detalhes</Text>
