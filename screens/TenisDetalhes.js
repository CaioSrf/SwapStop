...
const TenisDetalhes = () => {
  ...
  return (
    <View style={styles.tenisdetalhes}>
      ...
      <Text style={[styles.detalhesDoProduto, styles.tnis1Position]}>
        Detalhes do produto
      </Text>
      <Pressable
        style={styles.botoavanar}
        onPress={() => navigation.navigate("TenisEscPag")}
      >
        <View style={[styles.botoavanarChild, styles.botoavanarLayout]} />
        <View style={[styles.botoavanarItem, styles.botoavanarLayout]} />
        <Text style={[styles.avanar, styles.tnisTypo]}>AVANÇAR</Text>
      </Pressable>
    </View>
  );
};
