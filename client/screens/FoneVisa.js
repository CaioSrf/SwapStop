  ...
  return (
    <View style={styles.fonevisa}>
      <View style={[styles.barrainferior, styles.barrainferiorLayout]}>
        ...
        <Text style={styles.jblTune710bt}>JBL Tune 710BT</Text>
        <Text style={[styles.r40000, styles.textFlexBox]}>R$ 400,00</Text>
      </View>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("FoneCartes")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("FoneHiper")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("FoneMaster")}
      >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("NovoCartoFone")}
      >
      ...
      <Text style={[styles.r400001, styles.textFlexBox]}>R$ 400,00</Text>
    </View>
  );
};
