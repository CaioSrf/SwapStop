...
const TenisVisa = () => {
  ...
  return (
    <View style={styles.tenisvisa}>
      ...
      <View style={[styles.inferior, styles.inferiorLayout]}>
        <View style={[styles.inferiorChild, styles.inferiorLayout]} />
