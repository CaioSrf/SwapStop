...
const ComboQrCode = () => {
  ...
  return (
    <View style={styles.comboqrcode}>
      ...
      <Text style={[styles.comboDe37, styles.detalhesTypo]}>
        Combo de 37...
      </Text>
      <Text style={[styles.detalhes, styles.r400000Typo]}>Detalhes</Text>
